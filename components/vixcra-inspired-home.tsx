  ...
  return (
    <div className="relative min-h-[560px]">
      <motion.div
        ...
        className="relative overflow-hidden rounded-[2.4rem] border border-white/10 bg-[#f4f0e6] p-3 shadow-[0_48px_130px_-80px_rgba(216,255,99,.9)]"
      >
        <div className="relative aspect-[4/4.65] overflow-hidden rounded-[1.85rem] bg-[#080806]">
      ...
      <motion.div
        ...
        className="absolute -left-2 bottom-20 max-w-[18rem] overflow-hidden rounded-[1.8rem] border border-white/12 bg-[#080806] p-3 shadow-2xl sm:left-[-2.25rem]"
      >
        ...
        <div className="mt-4 flex items-center gap-3">
          <div className="flex gap-1 text-[#d9ff5f]">
      ...
      <motion.div
        ...
        className="absolute right-0 top-8 rounded-[1.6rem] border border-black/10 bg-[#d9ff5f] p-4 text-[#10100d] shadow-2xl sm:right-[-1.5rem]"
      >
      ...
      <motion.div
        animate={{ y: [0, 10, 0] }}
        transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
        className="absolute bottom-0 right-2 rounded-[1.7rem] border border-white/10 bg-[#080806]/88 p-4 backdrop-blur sm:right-10"
      >
        <p className="text-xs uppercase tracking-[0.28em] text-[#d9ff5f]">Services</p>
...
export function VixcraInspiredHome() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
          ...
          <div>
            ...
            <FadeIn delay={0.08}>
              <h1 className="max-w-4xl text-5xl font-semibold uppercase leading-[0.9] tracking-normal sm:text-7xl lg:text-8xl xl:text-9xl">
                Creative digital
                <span className="block text-[#d9ff5f]">solution</span>
            ...
            <FadeIn delay={0.14}>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <a href="#projects" className="rounded-full bg-[#d9ff5f] px-6 py-3 text-sm font-semibold text-[#10100d]">View My Work</a>
          ...
          <FadeIn delay={0.18} className="space-y-5">
            ...
            <div className="grid gap-4 sm:grid-cols-[.72fr_1fr]">
              <div className="rounded-[1.6rem] border border-white/10 bg-white/8 p-5">
                <div className="mb-3 flex gap-1 text-[#d9ff5f]">
                  {Array.from({ length: 5 }).map((_, index) => (
              ...
              <div className="rounded-[1.6rem] border border-white/10 bg-[#f4f0e6] p-5 text-[#10100d]">
                ...
                <a href="#projects" className="mt-5 inline-flex items-center gap-2 rounded-full bg-[#10100d] px-5 py-3 text-sm font-semibold text-[#f4f0e6]">
                  View My Work
                  <ArrowUpRight className="h-4 w-4" />
                </a>
              </div>
      ...
      <section className="border-y border-white/10 bg-[#d9ff5f] py-5 text-[#10100d]">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-10 lg:grid-cols-[.65fr_1.35fr] lg:items-start">
            <FadeIn className="space-y-5">
              <p className="text-sm uppercase tracking-[0.34em] text-[#d9ff5f]">_About Me</p>
              <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-[#f4f0e6] p-3">
                <div className="relative aspect-[4/5] overflow-hidden rounded-[1.4rem]">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 rounded-full bg-[#d9ff5f] px-4 py-2 text-center text-sm font-semibold text-[#10100d]">
            ...
            <FadeIn delay={0.08}>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <a href="#contact" className="rounded-full bg-[#d9ff5f] px-6 py-3 text-sm font-semibold text-[#10100d]">Contact Me</a>
            ...
            {stats.map((stat, index) => (
              <FadeIn key={stat.label} delay={index * 0.06}>
                <div className="h-full rounded-[1.8rem] border border-white/10 bg-white/[0.06] p-6">
                  <p className="text-5xl font-semibold tracking-normal text-[#d9ff5f]">{stat.value}</p>
          ...
          <div className="mt-14 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            {journey.map((item, index) => (
              <FadeIn key={item.year} delay={index * 0.05}>
                <div className="h-full rounded-[1.6rem] border border-white/10 bg-[#f4f0e6] p-5 text-[#10100d]">
      ...
      <section id="services" className="bg-[#f4f0e6] px-4 py-20 text-[#10100d] sm:py-28">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="space-y-5">
            {servicesData.map((service, index) => (
              <FadeIn key={service.title} delay={index * 0.04}>
                <div className="group grid gap-5 rounded-[2rem] border border-black/10 bg-white p-4 transition-colors hover:bg-[#10100d] hover:text-[#f4f0e6] lg:grid-cols-[.8fr_1fr_.5fr] lg:items-center lg:p-6">
                  <div className="overflow-hidden rounded-[1.4rem] bg-[#efeadf]">
                    <div className="relative aspect-[1.16] overflow-hidden">
                      ...
                      <div className="absolute bottom-4 left-4 right-4">
                        <p className="text-xs uppercase tracking-[0.24em] text-[#d9ff5f]">Service</p>
                  ...
                  <a href={`/services/${service.slug}`} className="inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#d9ff5f] text-[#10100d] transition-transform group-hover:-translate-y-1 group-hover:translate-x-1" aria-label={`View ${service.title}`}>
      ...
      <section className="px-4 py-20 sm:py-28">
        <div className="mx-auto max-w-7xl">
          <FadeIn className="mb-12 max-w-4xl">
            <p className="text-sm uppercase tracking-[0.34em] text-[#d9ff5f]">_Complete service menu</p>
          ...
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {servicesData.map((service, index) => (
              <FadeIn key={service.slug} delay={(index % 6) * 0.03}>
                <a href={`/services/${service.slug}`} className="group block h-full rounded-[1.5rem] border border-white/10 bg-white/[0.06] p-5 transition-colors hover:border-[#d9ff5f]/45 hover:bg-white/[0.1]">
                  <div className="flex items-start justify-between gap-4">
                    <p className="text-sm uppercase tracking-[0.24em] text-[#d9ff5f]">{String(index + 1).padStart(2, "0")}</p>
                    <ArrowUpRight className="h-5 w-5 text-white/35 transition-transform group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-[#d9ff5f]" />
                  </div>
      ...
      <section id="projects" className="px-4 py-20 sm:py-28">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 grid gap-6 lg:grid-cols-[.75fr_1.25fr] lg:items-end">
            <FadeIn>
              <p className="text-sm uppercase tracking-[0.34em] text-[#d9ff5f]">_Projects</p>
            </FadeIn>
            <FadeIn delay={0.08}>
              <h2 className="text-4xl font-semibold uppercase leading-[0.95] tracking-normal sm:text-6xl lg:text-8xl">
              ...
              <button
                ...
                className={cn(
                  ...
                  activeCategory === category
                    ? "border-[#d9ff5f] bg-[#d9ff5f] text-[#10100d]"
            ...
            {visibleProjects.map((project, index) => (
              <FadeIn key={project.title} delay={index * 0.04}>
                <article className="group rounded-[2rem] border border-white/10 bg-white/[0.06] p-4 transition-colors hover:bg-white/[0.1]">
                  <div className="relative aspect-[1.18] overflow-hidden rounded-[2rem] bg-[#f4f0e6]">
                    <img
                    ...
                    <div className="absolute bottom-5 left-5 right-5 flex items-end justify-between gap-4">
                      <div>
                        <p className="text-xs uppercase tracking-[0.24em] text-[#d9ff5f]">{project.category}</p>
                        <p className="mt-2 text-xl font-semibold text-white">{project.title}</p>
                      </div>
                      <span className="rounded-full bg-[#d9ff5f] px-3 py-1.5 text-xs font-semibold text-[#10100d]">{project.price}</span>
                    </div>
                  </div>
                  <div className="grid gap-4 p-2 pt-5 sm:grid-cols-[1fr_auto] sm:items-start">
                    <div>
                      <p className="text-sm text-[#d9ff5f]">{project.category}</p>
      ...
      <section className="bg-[#f4f0e6] px-4 py-20 text-[#10100d] sm:py-28">
        <div className="mx-auto max-w-7xl">
      ...
      <section className="px-4 py-20 sm:py-28">
        <div className="mx-auto max-w-7xl">
          <FadeIn className="mx-auto mb-12 max-w-3xl text-center">
            <p className="text-sm uppercase tracking-[0.34em] text-[#d9ff5f]">_Pricing</p>
            <h2 className="mt-5 text-4xl font-semibold uppercase leading-[0.95] tracking-normal sm:text-6xl lg:text-7xl">
          ...
          <div className="grid gap-5 lg:grid-cols-3">
            {plans.map((plan, index) => (
              <FadeIn key={plan.name} delay={index * 0.06}>
                <div className={cn("h-full rounded-[2rem] border p-6", plan.featured ? "border-[#d9ff5f] bg-[#d9ff5f] text-[#10100d]" : "border-white/10 bg-white/[0.06]")}>
                  ...
                  <a href="#contact" className={cn("mt-8 inline-flex w-full items-center justify-center rounded-full px-5 py-3 text-sm font-semibold", plan.featured ? "bg-[#10100d] text-[#f4f0e6]" : "bg-[#f4f0e6] text-[#10100d]")}>
                    Get Started
                  </a>
      ...
      <section id="contact" className="px-4 py-20 sm:py-28">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[.9fr_1.1fr]">
          <FadeIn>
            <p className="text-sm uppercase tracking-[0.34em] text-[#d9ff5f]">_Contact</p>
            ...
            <form className="rounded-[2rem] border border-white/10 bg-white/[0.06] p-5 sm:p-7">
              <div className="mb-5 overflow-hidden rounded-[1.5rem]">
                <div className="relative h-52">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <p className="text-xs uppercase tracking-[0.24em] text-[#d9ff5f]">Start the project</p>
                    <p className="mt-1 text-xl font-semibold text-white">Tell me what you want to build.</p>
                  </div>
                </div>
              </div>
              <div className="grid gap-4 sm:grid-cols-2">
                <input className="rounded-full border border-white/10 bg-white/8 px-5 py-4 text-sm text-white placeholder:text-white/35 outline-none focus:border-[#d9ff5f]" placeholder="First name" />
                <input className="rounded-full border border-white/10 bg-white/8 px-5 py-4 text-sm text-white placeholder:text-white/35 outline-none focus:border-[#d9ff5f]" placeholder="Last name" />
              </div>
              <input className="mt-4 w-full rounded-full border border-white/10 bg-white/8 px-5 py-4 text-sm text-white placeholder:text-white/35 outline-none focus:border-[#d9ff5f]" placeholder="Email address" />
              <div className="mt-4 grid gap-4 sm:grid-cols-2">
                <select className="rounded-full border border-white/10 bg-[#1a1a16] px-5 py-4 text-sm text-white outline-none focus:border-[#d9ff5f]">
              ...
              <textarea className="mt-4 min-h-36 w-full resize-none rounded-[1.4rem] border border-white/10 bg-white/8 px-5 py-4 text-sm text-white placeholder:text-white/35 outline-none focus:border-[#d9ff5f]" placeholder="Tell me about your project" />
              <button type="submit" className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-full bg-[#d9ff5f] px-6 py-4 text-sm font-semibold text-[#10100d]">
                Submit Now
                <ArrowUpRight className="h-4 w-4" />
              </button>
            </form>
